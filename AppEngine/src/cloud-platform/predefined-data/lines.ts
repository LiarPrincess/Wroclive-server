import { FirestoreLine } from '../FirestoreLinesDatabase';

export const lines: FirestoreLine[] = [
...
function createLine(name: string, type: string, subtype: string): FirestoreLine {
  const stopArrivalTimes = undefined;
  return { name, type, subtype, stopArrivalTimes };
}
